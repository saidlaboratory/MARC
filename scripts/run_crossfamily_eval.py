...
def main() -> None:
    ...
    print(f"Leave-one-family-out generalization — best-of-{args.K}, {args.test} test/family")
    ...
    for i, held in enumerate(fams):
        ...
        test = gen(held, args.test, seed0=100000)
        ...
        rows.append({
            "held_out": held.name,
            "trained_on": [f.name for f in train_fams],
    ...
    (out_dir / "crossfamily.json").write_text(
