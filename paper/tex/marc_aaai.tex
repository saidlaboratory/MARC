...
Second, the shrunken claim compresses into a law: a parameter-free
...
Third, the learned component relocates: moved off the value decision onto
...
fraction of the calls. Fourth, the same discipline turned
...
reusable form. Alongside the arc we contribute the substrate itself, a pre-registered entrapment result, a
...
(the structural-repair section) lives or dies by it. Repair-style studies build their population from
...
ceiling at $n = 1$. The law's larger-sample measurement below reads random lower at low $n$
...
the Protocol section; $N{=}367$ trained-$k$, $331$ held-out-$k$ failures, three
