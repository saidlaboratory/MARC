...
free parameters (mean absolute error 0.012). A real geometric domain confirms both conditions
are needed: its reachability collapses, yet a trained proposal there ties random search,
lacking a per-variable marginal to amortize. The decision classical solvers cannot make is
discrete: which structural augmentation turns an
