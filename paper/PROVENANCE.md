...
| R22 | v0.3 repair ranker, multi-seed robustness | **pending regeneration under v8** (issue #103; prior multiseed reused one random-arm draw across seeds, population_sd 0.0 artifact) | `python3 scripts/run_repair_multiseed.py ...` after #103 lands | do not cite the v6 multiseed rows | — |
